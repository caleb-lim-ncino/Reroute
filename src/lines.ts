...
// text colour that stays legible on the line colour.
...
export const LINE_STYLES: Record<string, LineStyle> = {
  bakerloo: { name: "Bakerloo", colour: "#B36305", ink: LIGHT },
  ...
  victoria: { name: "Victoria", colour: "#0098D4", ink: LIGHT },
  "waterloo-city": { name: "W&C", colour: "#95CDBA", ink: DARK },
  dlr: { name: "DLR", colour: "#00A4A7", ink: LIGHT },
  ...
  windrush: { name: "Windrush", colour: "#ED1B00", ink: LIGHT },
};
...
const FALLBACK: LineStyle = { name: "", colour: "#777", ink: LIGHT };
